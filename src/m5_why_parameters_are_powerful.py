...
def main():
    ...
    # better_draw_circles(rg.Point(-200, 0),25)
    # even_better_draw_circles(rg.Point(100, 50), 3, 25, 'green', 2)
    # even_better_draw_circles(rg.Point(-200, 0), 20, 4, 'blue', 10)

    even_better_draw_circles(rg.Point(0, 0), 15, 40, 'blue', 18)
    even_better_draw_circles(rg.Point(-300, 200), 15, 10, 'yellow', 18)
    even_better_draw_circles(rg.Point(-275, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(-250, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(-225, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(-200, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(-175, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(-150, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(-125, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(-100, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(-75, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(-50, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(-25, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(0, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(25, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(50, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(75, -250), 15, 10, 'green', 18)
    even_better_draw_circles(rg.Point(100, -250), 15, 10, 'green', 18)
...
def even_better_draw_circles(point, radius, num_circles, color, pen_thickness):
    turtle = rg.SimpleTurtle()
    turtle.speed = 10
    turtle.pen = rg.Pen(color, pen_thickness)
    turtle.pen_up()
    turtle.go_to(point)
    turtle.set_heading(0)  # Point "east" (towards the right)

    for k in range(1, num_circles):  # k becomes 1, 2, 3, ... 10
